package com.sh.im.http.controller;
...
import com.sh.im.http.entity.ImChatGroup;
import com.sh.im.http.entity.ImChatGroupUser;
import com.sh.im.http.entity.ImChatUserGroupMessage;
import com.sh.im.http.service.ImChatGroupService;
import com.sh.im.http.service.ImChatGroupUserService;
import com.sh.im.http.service.ImChatUserGroupMessageService;
import com.sh.im.http.vo.GroupVO;
...
public class ImChatGroupController {
    ...
    public PoetryResult addGroupTopic(@RequestParam("id") Integer id) {
        ...
        Integer count = lambdaQuery.eq(ImChatGroup::getId, id)
                .eq(ImChatGroup::getGroupType, ImConfigConst.GROUP_TOPIC).count().intValue();
        if (count == 1) {
            TioWebsocketStarter tioWebsocketStarter = TioUtil.getTio();
            if (tioWebsocketStarter != null) {
