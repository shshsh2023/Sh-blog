...
import com.sh.dao.*;
import com.sh.entity.*;
import com.sh.service.UserService;
import com.sh.utils.cache.PoetryCache;
import com.sh.vo.FamilyVO;
...
public class CommonQuery {
    ...
    public Integer getCommentCount(Integer source, String type) {
        ...
        int c = wrapper.eq(Comment::getSource, source).eq(Comment::getType, type).count().intValue();
            ...
            if (sortInfo == null) {
                ...
                if (!CollectionUtils.isEmpty(sorts)) {
                    sorts.forEach(sort -> {
                        ...
                        Long countOfSort = sortWrapper.eq(Article::getSortId, sort.getId()).count();
                        ...
                        if (!CollectionUtils.isEmpty(labels)) {
                            labels.forEach(label -> {
                                ...
                                Long countOfLabel = labelWrapper.eq(Article::getLabelId, label.getId()).count();
