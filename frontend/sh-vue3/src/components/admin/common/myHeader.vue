      ...
      <div class="header-user-con">
        <el-dropdown placement="bottom">
          ...
          <template v-slot:dropdown>
            <el-dropdown-menu>
              <el-dropdown-item v-if="$common.isEmpty(curAdmin)" @click="verifyAdmin()">验证admin</el-dropdown-item>
...
const curAdmin = store.state.currentAdmin;
//
...
const logout = () => {
  http.get(constant.baseURL + "/user/logout", {}, true)
      .then(() => {
      })
      .catch((error) => {
        ElMessage({
