    ...
    <div class="friend-wrap">
      <div class="friend-main">
        ...
        <div @click="clickLetter()" class="form-wrap">
          <!-- 信封上面 -->
          <img class="before-img" :src="$store.state.sysConfig['webStaticResourcePrefix'] + '/src/assets/imgs/bg.jpg'"
               style="width: 100%"/>
          <!-- 信 -->
          <div class="envelope" style="animation: hideToShow 2s">
            <div class="form-main">
              <img :src="$store.state.sysConfig['webStaticResourcePrefix'] + '/src/assets/imgs/bg.jpg'"
                   style="width: 100%"/>
              <div>
          ...
          <img class="after-img"
               :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/friendLetterBottom.png'"
               style="width: 100%"/>
        </div>
...
const submitFriend = () => {
  ...
  http.post(constant.baseURL + "/webInfo/saveFriend", friend.value)
      .then(() => {
...
const getFriends = () => {
  http.get(constant.baseURL + "/webInfo/listFriend")
      .then((res) => {
