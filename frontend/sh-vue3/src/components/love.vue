  ...
  <div>
    ...
    <div class="bg-wrap my-animation-slide-top">
      ...
      <div class="love-wrap transformCenter">
        ...
        <div>
          <img class="love-img" :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/loveLike.svg'"
               alt="心心">
        </div>
        <div>
    ...
    <div class="love-container">
              ...
              <div class="family-wrap"
                ...
                <div>
                  <img class="family-img"
                       :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/loveLike.svg'" alt="心心">
                </div>
                <div>
      ...
      <el-dialog title="入住表白墙"
        ...
        <div>
          <div class="form-main">
            <img :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/friendLetterMiddle.jpg'"
                 style="width: 100%"/>
            <div>
              <div>
              ...
              <div>
                <img :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/friendLetterBiLi.png'"
...
const treeHole = () => import( "./common/treeHole.vue");
const comment = () => import( "./comment/comment.vue");
const myFooter = () => import( "./common/myFooter.vue");
const photo = () => import( "./common/photo.vue");
const proTag = () => import( "./common/proTag.vue");
